...
public class EmailService {
    ...
    private String buildVerificationEmailTemplate(String userName, String verificationUrl) {
        return "<!DOCTYPE html>" +
                ...
                "        .button { display: inline-block; padding: 12px 30px; background-color: #4A90E2; color: #ffffff !important; text-decoration: none; border-radius: 5px; margin: 20px 0; font-weight: bold; }" +
    ...
    private String buildPasswordResetEmailTemplate(String userName, String resetUrl) {
        return "<!DOCTYPE html>" +
                ...
                "        .header h1 { margin: 0; font-size: 28px; font-weight: bold; }" +
                "        .content { background-color: #ffffff; padding: 30px; }" +
                "        .button { display: inline-block; padding: 12px 30px; background-color: #E94B3C; color: #ffffff !important; text-decoration: none; border-radius: 5px; margin: 20px 0; font-weight: bold; }" +
                "        .footer { text-align: center; padding: 20px; background-color: #f9f9f9; font-size: 12px; color: #999; }" +
